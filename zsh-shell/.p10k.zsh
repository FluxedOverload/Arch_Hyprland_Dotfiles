# Generated by Powerlevel10k configuration wizard on 2025-01-11 at 14:21 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#f7768a'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#bb9af7'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#bb9af7'
  ...
  # These settings are used for repositories other than Git or when gitstatusd fails an#d
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#7dcfff'
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND='#7dcfff'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#bb9af7'
